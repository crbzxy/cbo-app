        ...
        <div className='contenedor-hero'>
          <div className='hero'>
            <div className='texto'>
              ...
              <br />
              <h1>Carlos Boyzo, Diseñador y Dev web UI-UX-IXD.</h1>

              <p>
                Hola, me enfoco en crear soluciones y experiencias digitales
                positivas, que conecten los objetivos comerciales de mis
                clientes en diferentes verticales de negocio.
              </p>
              <p>
        ...
        <div className='contenedor text-left'>
          ...
          <div className='contenedor-experiencia'>
            <div className='experiencia-card'>
              <h3 className='titulo'>Estrategia y Dirección digital</h3>
              <p>
                Planifiquemos el desarrollo por el camino más adecuado para
                lograr tus objetivos de comunicación digital.
              </p>
            </div>
            <div className='experiencia-card'>
              <h3 className='titulo'>Diseño UI/UX/IXD</h3>
              <p>
                Construyamos soluciones, prototipos y wireframes, con
                herramientas y metodologías para una mejor experiencia de los
                usuarios en productos y comunicación digital.
              </p>
            </div>
            <div className='experiencia-card'>
              <h3 className='titulo'>Desarrollo Web</h3>
              <p>
                Usemos herramientas eficientes, con presupuestos a la medida y
                avancemos al siguiente nivel, usando tecnologías nuevas con las
                mejores prácticas.
              </p>
            </div>
            <div className='experiencia-card'>
              ...
              <p>
                Obtén más tráfico en tus productos digitales, aparece en los
                principales buscadores y administra tu presencia digital para
                mejorar tus campañas publicitarias y posicionamiento.
              </p>
            </div>
            ...
            <div className='experiencia-card'>
              ...
              <p>
                Generemos diseño, videos y recursos de apoyo al área comercial
                para que tu marca o producto digital destaque todo su potencial.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='about-start  pb-5' data-aos='fade-up'>
        ...
        <div className=' d-flex container about-container'>
          ...
          <div className='col text-left  '>
            ...
            <a
              href='https://foundation.app/@perrodimensional'
              download
