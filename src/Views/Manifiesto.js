  ...
  return (
    <div className="contenedor">
      ...
      <div>
        ...
        <p>¿Quién ha atravesado la ciudad y por única música sólo ha tenido los silbidos de sus semejantes, sus propias palabras de asombro y rabia?</p>

        <p> El tipo hermoso que no sabía
          que el orgasmo de las chavas es clitoral</p>

        <p> (Busquen, no solamente en los museos hay mierda). (Un proceso de museificación individual). (Certeza de que todo está nombrado, develado). (Miedo a descubrir). (Miedo a los desequilibrios no previstos).
        </p>
        ...
        <p>Pequeñitas estrellas luminosas guiñándonos eternamente un ojo desde un lugar del universo llamado Los laberintos.
        ...
        <p>*</p>
        <p> Metan a toda la ciudad al manicomio. Dulce hermana, aullidos de tanque, canciones hermafroditas, desiertos de diamante, sólo viviremos una vez y las visiones cada día más gruesas y resbalosas. Dulce hermana, aventones para Monte Albán. Apriétense los cinturones porque se riegan los cadáveres. Una movida de menos.
        </p>
        <p>*</p>

        <p> ¿Y la buena cultura burguesa? ¿Y la academia y los incendiarios? ¿y las vanguardias y sus retaguardias? ¿Y ciertas concepciones del amor, el buen paisaje, la Colt precisa y multinacional?
